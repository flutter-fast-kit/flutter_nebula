...
///
/// Requires [NeThemeData] to work. Everything else is the same as in [MaterialApp].
class NebulaApp extends StatelessWidget {
  /// A theme that application uses. It can be your own theme, see [NeThemeData.configure()] or [NeThemeData.loadFromJson()],
