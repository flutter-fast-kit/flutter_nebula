...
export 'package:flutter_nebula/src/components/text_field/text_field_style.dart';

/// A Widget that is used to receive text information from user. Can be styled using [NeTextFieldTheme].
class NeTextField extends StatefulWidget {
  ...
  const NeTextField({
    ...
    this.icon,
    this.iconPosition = NePositioning.left,
    this.label,
    this.description,
  ...
  @override
  _NeTextFieldState createState() => _NeTextFieldState();
}
