...
final StyleData tabStyle = StyleData({
  ...
  'tab-text-font-family': 'button-text-font-family',
  'tab-text-font-weight': 'button-text-font-weight',
  'tab-text-font-size': 'button-text-medium-font-size',
});
